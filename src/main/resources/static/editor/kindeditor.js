...
KE.setting = {
    wyswyg@resourcesCommon : true,
    autoOnsubmit@resourcesCommon : true,
    resize@resourcesCommon : 2,
    filter@resourcesCommon : true,
    tagLine@resourcesCommon : false,
    skinType : 'default',
    cssPath : '',
...
KE.util = {
    getDocumentElement : function() {
        return (document.compat@resourcesCommon != "CSS1Compat") ? document.body : document.documentElement;
    },
    ...
    drag : function(id, mousedownObj, moveObj, func, hideFlag) {
        ...
        mousedownObj.onmousedown = function(event) {
            if (hideFlag && obj.wyswyg@resourcesCommon) obj.iframe.style.display = 'none';
            ...
            var upListener = function(event) {
                if (hideFlag && obj.wyswyg@resourcesCommon) obj.iframe.style.display = '';
                dragFlag = false;
    ...
    getFullHtml : function(id, tagLine@resourcesCommon) {
        var html = '<html>';
        html += '<head>';
        html += '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />';
        html += '<title>KindEditor</title>';
        if (tagLine@resourcesCommon) {
